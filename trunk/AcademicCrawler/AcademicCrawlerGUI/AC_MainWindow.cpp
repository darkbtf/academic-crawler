...
bool AC_MainWindow::setupSignalSlotMap( void )
{
    ...
    connect( this->actionExitMainWindow_, SIGNAL( triggered() ), this, SLOT( onExitMainWindow() ) );
    connect( this->actionAboutTheme_, SIGNAL( triggered() ), this, SLOT( onAboutTheme() ) );
    connect( this->actionAboutSoftware_, SIGNAL( triggered() ), this, SLOT( onAboutSoftware() ) );
...
//--------------------------------------------------------------------------------
bool AC_MainWindow::onExitMainWindow( void )
{
...
//--------------------------------------------------------------------------------
bool AC_MainWindow::onAboutTheme( void )
{
...
//--------------------------------------------------------------------------------
bool AC_MainWindow::onAboutSoftware( void )
{
