...
**
** Created: Thu Feb 24 16:51:47 2011
...
static const char qt_meta_stringdata_AC_MainWindow[] = {
    "AC_MainWindow\0\0bool\0exitMainWindow()\0"
    "aboutTheme()\0aboutSoftware()\0"
};
...
int AC_MainWindow::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: { bool _r = exitMainWindow();
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = _r; }  break;
        case 1: { bool _r = aboutTheme();
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = _r; }  break;
        case 2: { bool _r = aboutSoftware();
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = _r; }  break;
        default: ;
        }
        _id -= 3;
